...
public class DetailActivity extends Activity implements View.OnClickListener {
  ...
  private ArrayList<String> mPlaceReview;
  private ArrayAdapter mPlaceReviewsAdapter;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mTitle = (TextView) findViewById(R.id.provinceName);
    ...
    mPlaceReview = new ArrayList<>();
    mPlaceReviewsAdapter = new ArrayAdapter(this, R.layout.row_reviews, mPlaceReview);
    mList.setAdapter(mPlaceReviewsAdapter);
    ...
    switch (v.getId()) {
      case R.id.btn_add:
        if (!isEditTextVisible) {
          ...
          mPlaceReviewsAdapter.notifyDataSetChanged();
